...
export class TestCategory extends TestTools {
    ...
    async run() {
        ...
        this.categoryNotFoundForEditing();
        this.categoryCreateGetEdit();
        this.categoryDelete();
    }
    ...
    */
    categoryGetWrongID() {
        this.fire.category.get('wrong-category-id')
            ...
            .catch(e => this.test(e.code === CATEGORY_DOES_NOT_EXIST,
                'Expect error on getting a category with wrong id', e.code, e.message));
    }
