...
export class TestCategory extends TestTools {
    ...
    async categoryEmptyID() {
        const isLoginAdmin = await this.loginAsAdmin();
        if ( isLoginAdmin ) {
            ...
            this.bad('categoryEmptyID: Login failed.');
        }
    ...
    async categoryCreateWrongID() {
        ...
        if ( isLogin ) {
            ...
            this.bad('categoryCreateWrongID: Login failed.');
        }
    ...
    */
    async categoryCreateExist() {
        ...
        if ( isLogin ) {
            ...
            this.bad('categoryCreateExist: Login failed.');
        }
    ...
    */
    async categoryGetWrongID() {
        ...
        if ( isLogin ) {
            ...
            this.bad('categoryGetWrongID: Login failed.');
        }
    ...
    */
    async  categoryNotFoundForEditing() {
        ...
        if ( isLogin ) {
            ...
            this.bad('categoryNotFoundForEditing: Login failed.');
        }
    ...
    async categoryCreateGetEdit() {
        ...
        if ( isLogin ) {
            ...
            this.bad('categoryCreateGetEdit: Login failed.');
        }
    ...
    async categoryDelete() {
        ...
        if ( isLogin ) {
            ...
            await this.fire.category.create({ id: categoryId, name: name, numberOfPosts: 1 })
            .then(re => {
            ...
            await this.fire.category.create({ id: categoryId + '-2' })
            .then(re => {
                return this.fire.category.delete(re.data.id);
            })
            .then(() => {
            ...
            await this.fire.category.delete('this-is-wrong-category-id')
            ...
            this.bad('categoryDelete: Login failed.');
        }
